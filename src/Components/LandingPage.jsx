  ...
  const services = [
    {
      ...
      description: "Delivering exceptional banking services with enforced standards and best practices for optimal customer satisfaction",
      icon: <Users className="w-8 h-8 text-black" />,
    },
    {
      title: "Virtual Assistant",
      description: "Comprehensive support including inbox management, calendar organization, and travel planning",
      icon: <Layout className="w-8 h-8 text-black" />,
    },
    {
      title: "Queue Management",
      description: "Enhancing customer experiences through digital channel migration and efficient floor management",
      icon: <Users className="w-8 h-8 text-black" />,
    },
    {
      title: "Operations Management",
      description: "Expert handling of internal accounts maintenance and credit operations support",
      icon: <FileText className="w-8 h-8 text-black" />,
    },
    {
      title: "Team Leadership",
      description: "Building and supporting effective teams with focus on resource allocation and high-impact initiatives",
      icon: <Users className="w-8 h-8 text-black" />,
    },
    {
      title: "Innovation Champion",
      description: "Driving operational excellence and digital transformation in banking services",
    ...
    <div className="min-h-screen">
      ...
      <section className="min-h-screen relative">
        ...
        <div 
          ...
          style={{
            backgroundImage: "url('src/assets/Images/Wallpaper.jpg')",
        ...
        {/* Navigation */}
        <nav className="absolute w-full top-0 z-50 bg-black/10 backdrop-blur-sm">
          <div className="container mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              <div className="font-black text-white text-4xl p-4 hover:text-pink-300 transition-colors duration-300">
                Evelynne Bett
              </div>
              <div className="flex space-x-6">
                <a href="/" className="text-white hover:text-pink-300 transition font-bold px-4 py-2">Home</a>
                
                <a href="/Contact" className="text-white hover:text-pink-300 transition font-bold px-4 py-2">Contact Me</a>
              </div>
            </div>
          </div>
        </nav>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-gray-300">
                Senior Banking Professional with 12+ years of experience in customer service excellence,
...
>
  <button className="bg-gradient-to-r from-pink-300 to-white text-black px-8 py-3 rounded-full 
    ...
    Hire Me
      ...
      {/* About Section */}
      <section id="about" className="py-20 bg-gradient-to-b from-black via-gray-900 to-pink-50">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-300 mb-6">
                Accomplished bank custodian, senior teller and customer-centric service desk officer with 12+ years of experience in the banking industry. 
                Proficient at improving customer satisfaction and service delivery by leveraging excellent communication, interpersonal, and problem-solving skills.
              </p>
              <div className="space-y-4">
                <h4 className="text-xl font-bold text-white">Core Competencies</h4>
                <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg">
                  <h5 className="font-bold text-white">Customer Service Champion</h5>
                  <ul className="text-gray-300 mt-2 space-y-2">
                    <li>• Enforcement of service standards and best practices</li>
                ...
                <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg">
                  <h5 className="font-bold text-white">Virtual Assistant Excellence</h5>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg">
                  <h4 className="font-bold mb-2 text-white">Banking Operations</h4>
                ...
                <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg">
                  <h4 className="font-bold mb-2 text-white">Queue Management</h4>
                  <div className="space-y-2">
                    <div className="flex justify-between text-gray-300">
                ...
                <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg">
                  <h4 className="font-bold mb-2 text-white">Google Workspace</h4>
                  <div className="space-y-2">
                    <div className="flex justify-between text-gray-300">
  ...
  <div className="container mx-auto px-6">
    ...
    <div className="grid md:grid-cols-3 gap-8">
      ...
      {/* Contact Section */}
      <section id="contact" className="py-20 bg-gradient-to-b from-pink-50 to-black">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold mb-8 text-gray-800">Let's Connect</h2>
            <div className="flex justify-center space-x-8 mb-12">
              <a href="mailto:bett.everlyne@gmail.com" className="flex items-center space-x-2 text-gray-700 hover:text-pink-500 transition">
                <Mail className="w-6 h-6" />
                <span>bett.everlyne@gmail.com</span>
              </a>
              <a href="tel:+254720155133" className="flex items-center space-x-2 text-gray-700 hover:text-pink-500 transition">
